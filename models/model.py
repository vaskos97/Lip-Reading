...
from models.models.resnet import ResNet, BasicBlock
from models.models.shufflenetv2 import ShuffleNetV2
from models.models.tcn import MultibranchTemporalConvNet, TemporalConvNet
...
class Lipreading(nn.Module):
    def __init__( self, hidden_dim=256, backbone_type='resnet', num_classes=300,
        ...
        tcn_class = MultiscaleMultibranchTCN #TCN if len(tcn_options['kernel_size']) == 1 else MultiscaleMultibranchTCN
